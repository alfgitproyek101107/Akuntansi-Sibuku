...
@section('title', 'Edit Aturan Pajak')
@section('page-title', 'Edit Aturan Pajak')
    ...
    <header class="dashboard-header">
        <div class="header-container">
            <div class="header-left">
                ...
                <h1 class="page-title">Edit Aturan Pajak</h1>
                <p class="page-subtitle">Perbarui informasi aturan pajak "{{ $taxRule->name }}"</p>
            </div>
        ...
        <div class="content-grid">
            ...
            <section class="form-section">
                <div class="form-card">
                    ...
                    <div class="form-body">
                        <form method="POST" action="{{ route('tax-rules.update', $taxRule) }}" id="taxRuleForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <div class="tax-type-cards">
                                    <div class="tax-type-card input {{ old('type', $taxRule->type) == 'input' ? 'selected' : '' }}" data-type="input" onclick="selectTaxType('input')">
                                    ...
                                    <div class="tax-type-card output {{ old('type', $taxRule->type) == 'output' ? 'selected' : '' }}" data-type="output" onclick="selectTaxType('output')">
                                        <div class="tax-type-icon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                ...
                                <input type="hidden" name="type" id="taxTypeInput" value="{{ old('type', $taxRule->type) }}" required>
                                @error('type')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ $errors->has('name') ? 'error' : '' }}"
                                       id="name" name="name" value="{{ old('name', $taxRule->name) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" min="0" max="100" class="form-control {{ $errors->has('percentage') ? 'error' : '' }}"
                                           id="percentage" name="percentage" value="{{ old('percentage', $taxRule->percentage) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control {{ $errors->has('code') ? 'error' : '' }}"
                                       id="code" name="code" value="{{ old('code', $taxRule->code) }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control {{ $errors->has('description') ? 'error' : '' }}"
                                          ...
                                          placeholder="Deskripsikan aturan pajak ini...">{{ old('description', $taxRule->description) }}</textarea>
                                @error('description')
                                    <div class="form-error">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <circle cx="12" cy="12" r="10"></circle>
                            ...
                            <div class="form-group">
                                ...
                                <div class="status-toggle">
                                    <label class="toggle-switch">
                                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $taxRule->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="form-actions">
                                <a href="{{ route('tax-rules.show', $taxRule) }}" class="btn-secondary">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Auto-select current type
    const currentType = taxTypeInput.value;
    if (currentType) {
        selectTaxType(currentType);
    }
