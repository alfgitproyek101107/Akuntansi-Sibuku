    ...
    <header class="dashboard-header">
        <div class="header-container">
            <div class="header-left">
                ...
                <h1 class="page-title">Manajemen Transfer</h1>
                <p class="page-subtitle">Kelola transfer antar rekening dengan mudah dan aman</p>
            </div>
            <div class="header-right">
                <a href="{{ route('transfers.create') }}" class="btn-primary">
                    ...
                    <span>Tambah Transfer Baru</span>
                </a>
            </div>
        </div>
    </header>
    ...
    <main class="dashboard-main">
        ...
        <section class="metrics-section">
            <div class="metrics-grid">
                ...
                <div class="metric-card metric-success">
                    ...
                    <div class="metric-content">
                        <div class="metric-value">{{ $transfers->where('date', '>=', now()->startOfMonth())->count() }}</div>
                        <div class="metric-details">
                            <span class="metric-label">Transfer bulan ini</span>
                            <div class="metric-trend positive">
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline>
                                </svg>
                    ...
                    <div class="metric-sparkline">
                        <canvas id="monthlyTransfersSparkline"></canvas>
                    </div>
                </div>
                ...
                <div class="metric-card metric-warning">
                    <div class="metric-header">
                        ...
                        <div class="metric-badge">
                            <span>Total Dana Transfer</span>
                        </div>
                    </div>
                    <div class="metric-content">
                        <div class="metric-value">Rp{{ number_format($transfers->sum('amount'), 0, ',', '.') }}</div>
                        <div class="metric-details">
                            <span class="metric-label">Semua transfer</span>
                            <div class="metric-trend positive">
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="metric-card metric-info">
                    ...
                    <div class="metric-content">
                        <div class="metric-value">Rp{{ number_format($transfers->avg('amount') ?: 0, 0, ',', '.') }}</div>
                        <div class="metric-details">
                            <span class="metric-label">Rata-rata transfer</span>
                    ...
                    <div class="metric-sparkline">
                        <canvas id="averageTransferSparkline"></canvas>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="table-section">
            <div class="section-header">
                <div class="section-title-group">
                    <h2 class="section-title">Daftar Transfer</h2>
                    <p class="section-subtitle">Kelola semua transfer antar rekening Anda</p>
                </div>
                                ...
                                <tr class="transfer-row">
                                    ...
                                    <td>
                                        <div class="transfer-account">
                                            ...
                                            <div class="account-name">{{ $transfer->fromAccount->name ?? 'Rekening Tidak Ditemukan' }}</div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="transfer-account">
                                            ...
                                            <div class="account-name">{{ $transfer->toAccount->name ?? 'Rekening Tidak Ditemukan' }}</div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <a href="{{ route('transfers.edit', $transfer) }}" class="action-btn edit-btn" title="Edit">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                                </svg>
                                            </a>
                                            <form method="POST" action="{{ route('transfers.destroy', $transfer) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus transfer ini?')" class="inline">
                                                @csrf
                                                @method('DELETE')
        ...
        <section class="empty-section">
            <div class="empty-state">
                ...
                <h3 class="empty-title">Belum ada data transfer</h3>
                <p class="empty-description">Mulailah mentransfer dana antar rekening untuk mengoptimalkan pengelolaan keuangan Anda</p>
            ...
            <div class="actions-grid">
                <a href="{{ route('transfers.create') }}" class="action-card">
                    ...
                    <div class="action-content">
                        <h3 class="action-title">Tambah Transfer</h3>
                        <p class="action-description">Pindahkan dana antar rekening</p>
                    </div>
                ...
                <a href="{{ route('dashboard') }}" class="action-card">
                    ...
                    <div class="action-content">
                        ...
                        <p class="action-description">Lihat ringkasan keuangan</p>
                    </div>
                    <div class="action-arrow">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="9 18 15 12 9 6"></polyline>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Monthly Transfers Sparkline
    const monthlyTransfersCtx = document.getElementById('monthlyTransfersSparkline')?.getContext('2d');
    if (monthlyTransfersCtx) {
    ...
    // Average Transfer Sparkline
    const averageTransferCtx = document.getElementById('averageTransferSparkline')?.getContext('2d');
    if (averageTransferCtx) {
        new Chart(averageTransferCtx, {
            type: 'bar',
            data: {
                labels: ['', '', '', '', '', '', ''],
                datasets: [{
    ...
    filterOptionBtns.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            filterTransfersByType(filterType);
...
// Filter transfers by type function
function filterTransfersByType(type) {
    const rows = document.querySelectorAll('#transfersTableBody .transfer-row');
