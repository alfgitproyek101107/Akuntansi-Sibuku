...
@section('page-title', 'Tambah Transfer')
    ...
    <header class="dashboard-header">
        <div class="header-container">
            <div class="header-left">
                ...
                <h1 class="page-title">Tambah Transfer</h1>
                <p class="page-subtitle">Pindahkan dana antar rekening dengan mudah dan aman</p>
            </div>
            ...
            <div class="form-section">
                <div class="form-container">
                    <div class="form-header">
                        ...
                        <h2 class="form-title">Form Transfer Dana</h2>
                        <p class="form-subtitle">Isi form di bawah untuk melakukan transfer dana</p>
                    </div>
                        ...
                        <form method="POST" action="{{ route('transfers.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="account-grid from-box">
                                    @foreach($accounts as $account)
                                        <div class="account-card {{ old('from_account_id') == $account->id ? 'selected' : '' }}"
                                            ...
                                            <input type="radio" name="from_account_id" value="{{ $account->id }}"
                                                   {{ old('from_account_id') == $account->id ? 'checked' : '' }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="account-grid to-box">
                                    @foreach($accounts as $account)
                                        <div class="account-card {{ old('to_account_id') == $account->id ? 'selected' : '' }}"
                                            ...
                                            <input type="radio" name="to_account_id" value="{{ $account->id }}"
                                                   {{ old('to_account_id') == $account->id ? 'checked' : '' }}
                                                   style="display: none;" required>
                                        </div>
                                    @endforeach
                                </div>
                ...
                <div class="tips-container">
                    ...
                    <div class="tips-content">
                        <div class="tip-item">
                            ...
                            <div class="tip-text">
                                <h4>Periksa Saldo</h4>
                                <p>Pastikan rekening sumber memiliki saldo yang cukup untuk melakukan transfer.</p>
                            </div>
                        </div>
                        ...
                        <div class="tip-note">
                            ...
                            <div class="note-text">
                                <h4>Penting</h4>
                                <p>Transfer yang telah diproses tidak dapat dibatalkan. Pastikan semua informasi sudah benar sebelum menekan tombol "Proses Transfer".</p>
                            </div>
                        </div>
                    </div>
                </div>
