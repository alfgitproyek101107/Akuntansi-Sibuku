    ...
    <header class="dashboard-header">
        <div class="header-container">
            <div class="header-left">
                ...
                <p class="page-subtitle">Kelola semua transaksi pemasukan dan pendapatan Anda</p>
            </div>
    ...
    <main class="dashboard-main">
        ...
        <section class="metrics-section">
            <div class="metrics-grid">
                ...
                <div class="metric-card metric-primary">
                    ...
                    <div class="metric-content">
                        ...
                        <div class="metric-details">
                            <span class="metric-label">Semua pemasukan</span>
                ...
                <div class="metric-card metric-success">
                    ...
                    <div class="metric-content">
                        <div class="metric-value">{{ $incomes->where('date', '>=', now()->startOfMonth())->count() }}</div>
                        <div class="metric-details">
                ...
                <div class="metric-card metric-warning">
                    ...
                    <div class="metric-content">
                        <div class="metric-value">Rp{{ number_format($incomes->sum('amount'), 0, ',', '.') }}</div>
                        <div class="metric-details">
                            <span class="metric-label">Semua pemasukan</span>
                            <div class="metric-trend positive">
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="metric-sparkline">
                        <canvas id="totalIncomeSparkline"></canvas>
                    </div>
                </div>
                ...
                <div class="metric-card metric-info">
                    ...
                    <div class="metric-content">
                        <div class="metric-value">Rp{{ number_format($incomes->avg('amount') ?: 0, 0, ',', '.') }}</div>
                        <div class="metric-details">
                            <span class="metric-label">Rata-rata pemasukan</span>
                    ...
                    <div class="metric-sparkline">
                        <canvas id="averageIncomeSparkline"></canvas>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="table-section">
            <div class="section-header">
                <div class="section-title-group">
                    <h2 class="section-title">Daftar Pemasukan</h2>
                    <p class="section-subtitle">Kelola semua transaksi pemasukan Anda</p>
                </div>
                <div class="section-actions">
                    <div class="search-input">
                        ...
                        <input type="text" id="incomeSearch" placeholder="Cari pemasukan..." onkeyup="filterIncomes(this.value)">
                    </div>
                                ...
                                <tr class="income-row">
                                    <td>
                                        <div class="income-date">
                                            ...
                                            <div class="date-details">
                                                <div class="date-value">{{ $income->date->format('d M Y') }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="income-account">
                                            ...
                                            <div class="account-name">{{ $income->account->name }}</div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="income-category">
                                            ...
                                            <div class="category-name">{{ $income->category ? $income->category->name : 'Tidak ada kategori' }}</div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a href="{{ route('incomes.show', $income) }}" class="action-btn view-btn" title="Lihat Detail">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                                    <circle cx="12" cy="12" r="3"></circle>
                                                </svg>
                                            </a>
                                            <a href="{{ route('incomes.edit', $income) }}" class="action-btn edit-btn" title="Edit">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                                </svg>
                                            </a>
                                            <form method="POST" action="{{ route('incomes.destroy', $income) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pemasukan ini?')" class="inline">
                                                @csrf
                                                @method('DELETE')
        ...
        <section class="empty-section">
            <div class="empty-state">
                ...
                <h3 class="empty-title">Belum ada data pemasukan</h3>
                <p class="empty-description">Mulailah mencatat semua sumber pendapatan Anda untuk melacak kesehatan keuangan</p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const totalIncomeCtx = document.getElementById('totalIncomeSparkline')?.getContext('2d');
    if (totalIncomeCtx) {
    ...
    // Average Income Sparkline
    const averageIncomeCtx = document.getElementById('averageIncomeSparkline')?.getContext('2d');
    if (averageIncomeCtx) {
        new Chart(averageIncomeCtx, {
            type: 'bar',
            data: {
                labels: ['', '', '', '', '', ''],
                datasets: [{
    ...
    filterOptionBtns.forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            filterIncomesByType(filterType);
...
function filterIncomes(searchTerm) {
    const rows = document.querySelectorAll('#incomesTableBody .income-row');
...
// Filter incomes by type function
function filterIncomesByType(type) {
    const rows = document.querySelectorAll('#incomesTableBody .income-row');
